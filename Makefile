...
BUILDER_LIBS=-built-in-libraries "$(ARDUINO_HOME)/libraries" -libraries "/Users/martin/Documents/Arduino/libraries"
...
deploy:
	...
	ssh -t pi@raspberrypi.local "sleep 1 && python reset.py" &
